...
bucket_name = config.get('aws_config', 'news_bucket_name')
...
print(f"Configured to use bucket: {bucket_name} in region: {aws_region}")
...
def main():
    try:
        ...
        consumer = KafkaConsumer(
            ...
            group_id='my-group',
            consumer_timeout_ms=10000,  # Consider removing for continuous operation
